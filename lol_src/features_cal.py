...
def calc_features_single_match(match_info, last_min = 10):
    """ Calculate all features for a single game, and returns a list
...
def calc_gold_at_min( match_info, last_min = 10):
    """
...
def identify_events( match_info, event_name, last_min):
    """
